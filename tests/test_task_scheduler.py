...
def test_scheduler_picks_one_due_task_and_advances_before_launch() -> None:
    ...
    tasks = [
        TaskDefinition(task_id="a", name="a", prompt="a", schedule_minutes=1, next_run_utc="2025-12-31T23:59:00.000Z"),
        TaskDefinition(task_id="b", name="b", prompt="b", schedule_minutes=1, next_run_utc="2025-12-31T23:59:00.000Z"),
    ]
